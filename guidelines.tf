...
## and in putty we need to connect to workstation and in that mkdie agent,cd agent,and need to download that link curl -L -O https://vstsagentpackage.azureedge.net/agent/2.188.3/vsts-agent-linux-x64-2.188.3.tar.gz...
